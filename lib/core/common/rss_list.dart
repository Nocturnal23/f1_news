class RssList {
  ...
  static const Map<String, String> feedUrls = {
    ...
    'gazetta': 'https://www.gazzetta.it/dynamic-feed/rss/section/Formula-1.xml',
    'formulapassion': 'https://www.formulapassion.it/motorsport/formula-1/feed',
    'motorionline': 'https://f1grandprix.motorionline.com/feed/',
    'corriere': 'https://www.corrieredellosport.it/rss/formula-1'
  };
